...
public final class ProfileDtos {private ProfileDtos(){}
 public record Level(int level,String title,long currentLevelXp,Integer nextLevelXp,boolean maxLevel){}
 public record Badge(String code,String title,String description,String category,boolean unlocked,Instant unlockedAt,long currentProgress,int targetProgress,boolean pinned){}
